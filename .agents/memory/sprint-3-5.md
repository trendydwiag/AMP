...
- Dashboard context: `SITE_NAME` and `SITE_LOGO` added directly in `AMPStudioDashboardView.get_context_data()`
- No superuser existed in production DB until Task #2 is done; test admin created during sprint
